...
const LIGHT_THEMES = [
  { id:"saffron",    label:"Warm Cream",  sub:"Warm cream — amber accent", sw:["#F9F5EE","#FBF0E0","#D97706"], vars:{"--background":"38 55% 97%","--foreground":"20 20% 10%","--card":"36 45% 94%","--card-foreground":"20 20% 10%","--border":"36 20% 82%","--muted":"36 30% 88%","--muted-foreground":"25 15% 44%","--primary":"28 80% 46%","--primary-foreground":"0 0% 100%","--secondary":"36 30% 88%","--secondary-foreground":"20 18% 18%","--accent":"28 80% 46%","--accent-foreground":"0 0% 100%","--input":"36 20% 82%","--ring":"28 80% 46%","--surface-1":"36 40% 93%","--surface-2":"35 30% 88%"} },
